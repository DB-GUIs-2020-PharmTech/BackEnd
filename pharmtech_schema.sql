...
INSERT INTO drugs (name, description, sell_price, purchase_price, rec_stock_amount, unit_measure, drug_type) VALUES 
    ...
    ('Ibuprofen', 'Nonsteroidal anti-inflammatory drug. Reduces hormones that cause inflammation and pain in the body. Used to reduce fever and treat pain or inflammation caused by many conditions such as headache, toothache, back pain, arthritis, menstrual cramps, or minor injury.', 1.90, .80, 6000, 3),
